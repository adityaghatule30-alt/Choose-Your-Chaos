...
export async function POST(request: Request) {
  try {
    ...
    const validModes = ['who_sent_this', 'caption_battle', 'pick_for_me', 'either_or', 'mind_reader', 'two_truths']
    const gameMode = validModes.includes(body.game_mode) ? body.game_mode : 'who_sent_this'
