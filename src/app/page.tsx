      ...
      <div className="bg-gradient-to-b from-neutral-900 via-neutral-900/90 to-neutral-950 border border-neutral-800 rounded-3xl p-6 sm:p-12 relative overflow-hidden shadow-2xl">
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href="/play"
              className="px-6 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-yellow-400 hover:opacity-95 text-white font-black text-sm uppercase tracking-wider rounded-2xl shadow-xl shadow-purple-600/25 transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2"
            >
            ...
            <Link
              href="/rooms/create"
              className="px-5 sm:px-6 py-3.5 sm:py-4 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 hover:border-purple-500 text-white font-bold text-sm rounded-2xl transition-all flex items-center gap-2"
            >
            ...
            <Link
              href="/rooms"
              className="px-5 sm:px-6 py-3.5 sm:py-4 bg-neutral-950 hover:bg-neutral-900 border border-neutral-800 text-neutral-300 hover:text-white font-bold text-sm rounded-2xl transition-all flex items-center gap-2"
            >
              JOIN WITH CODE
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            <div>
              ...
              <p className="text-xs text-neutral-400 leading-relaxed">
                Submit your real-life moral conflicts to the community jury. Watch them cast verdicts: Innocent 😇, Guilty 😬, or Criminal 💀.
              </p>
            </div>
          ...
          {/* Card 4: Couples Games */}
          <Link
            href="/couples"
            className="group bg-neutral-900/90 border border-neutral-800 hover:border-pink-500/60 rounded-3xl p-6 sm:p-8 transition-all duration-300 transform hover:scale-[1.01] shadow-2xl flex flex-col justify-between"
          >
            <div>
              ...
              <div className="inline-flex px-2.5 py-0.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-[10px] font-black uppercase tracking-wider mb-2">
                PAIRS & DUOS
              </div>
              ...
              <p className="text-xs text-neutral-400 leading-relaxed">
                Test your telepathy in Memory Lane, engage in mutual accusations in Couple Chaos, and calculate compatibility in Ship or Skip.
              </p>
            </div>

            <div className="mt-6 pt-4 border-t border-neutral-800 flex items-center justify-between text-xs font-black text-pink-400">
              <span>EXPLORE COUPLES GAMES</span>
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </div>
          </Link>
        </div>
